...
struct ImFontConfig
{
    ...
    unsigned int    RasterizerFlags;        // 0x00     // Preferences for custom font rasterizer (e.g. ImGuiFreeType). Leave as zero if you aren't using one.
