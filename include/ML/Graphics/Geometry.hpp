	...
	namespace geo
	{
		...
		static constexpr rect_quad rectQuad(FloatRect const & rq, rect_uvs const & uv)
		{
			return
			{
				...
				rq.left(),  rq.bot(), 0.f,		1.0f, 1.0f, 1.0f,		uv[ 0],	uv[ 1],
				rq.left(),  rq.top(), 0.f,		1.0f, 1.0f, 1.0f,		uv[ 2],	uv[ 3],
				rq.right(), rq.top(), 0.f,		1.0f, 1.0f, 1.0f,		uv[ 4],	uv[ 5],
				rq.left(),  rq.bot(), 0.f,		1.0f, 1.0f, 1.0f,		uv[ 6],	uv[ 7],
				rq.right(), rq.top(), 0.f,		1.0f, 1.0f, 1.0f,		uv[ 8],	uv[ 9],
				rq.right(), rq.bot(), 0.f,		1.0f, 1.0f, 1.0f,		uv[10], uv[11],
			};
		}
